                ...
                content={
                  <div className="resOffers border-2 border-black rounded-[3px] p-[0.3rem]">
                    <div className="offerCarousels my-[0.3rem] mx-0 flex items-center overflow-x-scroll no-scrollbar">
                      {
                        currentRestaurant?.cta?.data?.[3]?.card?.card?.gridElements?.infoWithStyle?.offers?.map((offer, index) => <div className="offerCarousel border-2 border-black rounded-[3px] m-[0.3rem] mx-auto cursor-pointer hover:bg-black hover:text-white font-bold p-[0.5rem] flex items-center text-nowrap text-center w-auto h-[3rem]" key={index}>{offer?.info?.header}</div>)
                      }
                    </div>
                  </div>
                }
              ...
              <Accordion
                ...
                content={
                  <div>
                    ...
                    <button className="flex items-center justify-center border-black border-2 mx-auto mt-4 px-8 text-xl rounded py-4 hover:bg-black hover:text-white">Pay Now</button>
                  </div>
                }
